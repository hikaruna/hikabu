...
ActiveRecord::Schema[7.1].define(version: 2023_12_07_191742) do
  create_table "owned_stocks", id: false, force: :cascade do |t|
    ...
    t.index ["code"], name: "index_owned_stocks_on_code", unique: true
  end
